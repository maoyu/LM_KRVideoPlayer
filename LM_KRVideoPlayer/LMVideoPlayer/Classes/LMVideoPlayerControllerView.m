...
#import "LMVideoPlayerControllerView.h"
...
@interface LMVideoPlayerControllerView()
...
@end
@implementation LMVideoPlayerControllerView
...
- (void)layoutSubviews
{
    ...
    self.closeButton.frame = CGRectMake(CGRectGetWidth(self.topBar.bounds) - 50, -8, CGRectGetWidth(self.closeButton.bounds), CGRectGetHeight(self.closeButton.bounds));
