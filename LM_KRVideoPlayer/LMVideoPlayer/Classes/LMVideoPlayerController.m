...
@interface LMVideoPlayerController()

@property (nonatomic, strong) LMVideoPlayerControllerView *videoControl;
...
@implementation LMVideoPlayerController
...
- (LMVideoPlayerControllerView *)videoControl
{
    if (!_videoControl) {
        _videoControl = [[LMVideoPlayerControllerView alloc] init];
    }
